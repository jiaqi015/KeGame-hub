import type { DifficultyId, GameRules, OutcomeControlRules } from '../domain/models.js';
import { mergeRules } from '../domain/config/baseRules.js';
import { getDifficultyProfile } from '../domain/scenario-generation/difficultyProfiles.js';
