...
export const DIFFICULTY_OPTIONS: DifficultyOption[] = [
  {
    id: 'easy',
    label: '入门局',
    summary: '4 套房，窗口更宽，正向教学事件更多。',
    detail: '适合先熟悉节奏。你会更容易稳住业主，也更容易感受到月份和竞争联动。',
    scenarioCount: 3,
  },
  {
    id: 'standard',
    ...
    detail: '这是默认训练强度。既要做选择，也要开始承担联动伤害。',
    scenarioCount: 3,
  },
  {
    id: 'hard',
    ...
    detail: '适合练抗压与优先级。错误动作会更快传导到整组竞争盘。',
    scenarioCount: 3,
  },
];
...
function mergeRules(overrides?: Partial<GameRules>): GameRules {
  return {
    ...BASE_RULES,
    ...(overrides || {}),
...
const BUILT_IN_SCENARIOS: ScenarioDefinition[] = [
  {
    ...
    description: '4 套盘，窗口宽，脚本事件更友好，适合第一次上手。',
    startMonth: 9,
    startDay: 6,
    maxDay: 24,
  ...
  },
  {
    ...
    difficultyId: 'hard',
    name: '死线局',
    theme: '窗口极短，必须接受部分盘做牺牲',
    description: '6 套盘，脚本死线密集，最考验优先级。',
    startMonth: 2,
    startDay: 18,
    maxDay: 17,
    ...
    scriptedEvents: [
      { id: 'event-dead-1', day: 4, actor: '家里催促', title: '死线提前', message: '葛女士突然把卖房期限往前提了一周。', tone: 'danger', targetCaseId: 'case-jiangyue-dead', urgencyDelta: 7, windowDaysDelta: -2 },
