...
const BUILT_IN_SCENARIOS: ScenarioDefinition[] = [
  ...
  },
  {
    ...
    cases: [
      { id: 'case-ruiheli', housePrototypeId: 'proto-ruiheli-89', ownerArchetypeId: 'anxious', ownerName: '周女士', ownerMood: '担心拖久错过换房时机', maintainerName: '林序', askPrice: 828, bottomPrice: 785, initialTrust: 66, initialPatience: 72, initialHeat: 61, initialUrgency: 62, windowDays: 12 },
