...
const BUILT_IN_SCENARIOS: ScenarioDefinition[] = [
  ...
  },
  {
    ...
    name: '进阶窗口交火局',
    theme: '窗口更碎，先后手开始真正决定结果',
    description: '5 套盘，多个短窗口和竞品压力叠在一起，适合练优先级切换。',
    startMonth: 6,
    startDay: 12,
    maxDay: 20,
    ...
    competitionGroups: [
      { id: 'group-adv-qiantan', name: '前滩窗口踩踏', members: ['case-ruiheli-adv', 'case-xinghu-adv', 'case-jiangyue-adv'], priceElasticity: 1.2, customerSpillover: 0.6 },
    ...
    scriptedEvents: [
      ...
      { id: 'event-adv-3', day: 11, actor: '市场', title: '资产盘短暂回暖', message: '静安资产盘出现一波回暖，你得判断要不要抓这一小段窗口。', tone: 'success', targetMarketCellId: 'mc-jingan', demandHeatDelta: 6, sentimentDelta: 4 },
    ],
    published: true,
  },
  {
  ...
  },
  {
    ...
    description: '6 套盘，多数盘先天吃亏，窗口和关系都脆，适合专门练残局判断。',
    startMonth: 1,
    startDay: 9,
    maxDay: 17,
    rules: mergeRules({
