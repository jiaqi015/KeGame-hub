...
const BUILT_IN_SCENARIOS: ScenarioDefinition[] = [
  {
    ...
    name: '顺手开场局',
    theme: '把业主、带看和客户推进跑顺',
    description: '3 套盘，推进压力轻，市场顺风，适合先找回基本手感。',
    startMonth: 5,
    startDay: 9,
    maxDay: 28,
    rules: mergeDifficultyRules('warmup', { maxDay: 28, baseMaxEnergy: 5, initialEnergy: 5, initialCash: 24, initialReputation: 61, passiveLeadBaseMultiplier: 1.1, randomEventProbability: 0.09 }),
    randomEventPool: [
  ...
  },
  {
    ...
    description: '4 套盘，推进压力轻，突发消息更友好，适合第一局开场。',
    startMonth: 9,
    startDay: 6,
    maxDay: 22,
    rules: mergeDifficultyRules('easy', { maxDay: 22, initialCash: 22, initialReputation: 60, passiveLeadBaseMultiplier: 1.08, randomEventProbability: 0.1 }),
    randomEventPool: [
      { templateId: 'school-boom', weight: 5 },
    ...
    cases: [
      { id: 'case-ruiheli', housePrototypeId: 'proto-ruiheli-89', ownerArchetypeId: 'anxious', ownerName: '周女士', ownerMood: '担心拖久错过换房时机', maintainerName: '林序', askPrice: 828, bottomPrice: 785, initialTrust: 58, initialPatience: 72, initialHeat: 61, initialUrgency: 62, windowDays: 12 },
      { id: 'case-xinghuyuan', housePrototypeId: 'proto-xinghuyuan-92', ownerArchetypeId: 'fair-value', ownerName: '秦先生', ownerMood: '希望卖得稳，不想乱谈价', maintainerName: '沈岚', askPrice: 858, bottomPrice: 815, initialTrust: 60, initialPatience: 70, initialHeat: 57, initialUrgency: 54, windowDays: 14 },
      { id: 'case-jiayue', housePrototypeId: 'proto-jiayue-71', ownerArchetypeId: 'trial-balloon', ownerName: '梁先生', ownerMood: '想看看市场有没有惊喜', maintainerName: '韩起', askPrice: 632, bottomPrice: 594, initialTrust: 54, initialPatience: 46, initialHeat: 68, initialUrgency: 71, windowDays: 8 },
      { id: 'case-wanhang', housePrototypeId: 'proto-wanhang-63', ownerArchetypeId: 'fair-value', ownerName: '张阿姨', ownerMood: '更在意总价和安全感', maintainerName: '苏景', askPrice: 612, bottomPrice: 566, initialTrust: 56, initialPatience: 65, initialHeat: 60, initialUrgency: 55, windowDays: 11 },
    ],
    competitionGroups: [
    ...
    scriptedEvents: [
      { id: 'event-easy-1', day: 4, actor: '业主朋友圈', title: '同小区成交传闻', message: '周女士听说同小区有盘准备成交，心态稳了一点。', tone: 'success', targetCaseId: 'case-ruiheli', trustDelta: 2, urgencyDelta: -2 },
      { id: 'event-easy-2', day: 8, actor: '市场', title: '九月学区热', message: '前滩学区盘来访上升，相关房源热度被带起来。', tone: 'success', targetMarketCellId: 'mc-qiantan', demandHeatDelta: 5, sentimentDelta: 4 },
    ],
    published: true,
  },
  {
    ...
    scriptedEvents: [
      ...
      { id: 'event-easy-4', day: 9, actor: '业主家庭', title: '换房时间确认', message: '邵女士家里敲定换房时间，愿意多给你一点操作空间。', tone: 'success', targetCaseId: 'case-jiangyue-2', trustDelta: 4, windowDaysDelta: 2 },
    ],
    published: true,
  },
  {
  ...
  },
  {
    ...
    cases: [
      { id: 'case-ruiheli-cross', housePrototypeId: 'proto-ruiheli-89', ownerArchetypeId: 'fair-value', ownerName: '钱女士', ownerMood: '更重视你有没有把情况讲透', maintainerName: '许靖', askPrice: 822, bottomPrice: 788, initialTrust: 64, initialPatience: 67, initialHeat: 56, initialUrgency: 61, windowDays: 10 },
    ...
    scriptedEvents: [
      { id: 'event-cross-1', day: 6, actor: '业主家庭', title: '核销暗示', message: '顾女士家里人想先停下来观望，你得及时稳住。', tone: 'danger', targetCaseId: 'case-jiali-cross', trustDelta: -6, windowDaysDelta: -2 },
  ...
  },
  {
    ...
    name: '进阶交火局',
    theme: '推进更碎，先后手开始真正决定结果',
    description: '5 套盘，多条吃紧推进线和竞品压力叠在一起，适合练优先级切换。',
    startMonth: 6,
    startDay: 12,
    maxDay: 20,
    ...
    cases: [
      { id: 'case-ruiheli-adv', housePrototypeId: 'proto-ruiheli-89', ownerArchetypeId: 'anxious', ownerName: '周女士', ownerMood: '已经不想再慢慢等了', maintainerName: '林序', askPrice: 826, bottomPrice: 786, initialTrust: 58, initialPatience: 52, initialHeat: 57, initialUrgency: 75, windowDays: 8 },
    ...
    competitionGroups: [
      { id: 'group-adv-qiantan', name: '前滩踩踏组', members: ['case-ruiheli-adv', 'case-xinghu-adv', 'case-jiangyue-adv'], priceElasticity: 1.2, customerSpillover: 0.6 },
      { id: 'group-adv-jingan', name: '静安双盘互咬', members: ['case-jiayue-adv', 'case-jiali-adv'], priceElasticity: 0.97, customerSpillover: 0.45 },
    ],
    scriptedEvents: [
      { id: 'event-adv-1', day: 4, actor: '业主家庭', title: '时间表提前', message: '顾女士家里希望更快定方案，你的缓冲空间又被压缩了一截。', tone: 'danger', targetCaseId: 'case-jiangyue-adv', urgencyDelta: 6, windowDaysDelta: -1 },
      { id: 'event-adv-2', day: 7, actor: '竞品', title: '同组先动价', message: '前滩同组盘先一步试探价格，客户比较变得更直接。', tone: 'danger', targetMarketCellId: 'mc-qiantan', competitionPressureDelta: 9, sentimentDelta: -3 },
      { id: 'event-adv-3', day: 11, actor: '市场', title: '资产盘短暂回暖', message: '静安资产盘出现一波回暖，你得判断要不要抓这一小段机会。', tone: 'success', targetMarketCellId: 'mc-jingan', demandHeatDelta: 6, sentimentDelta: 4 },
    ],
    published: true,
  },
  {
    ...
    description: '6 套盘，推进吃紧，负向事件更多，适合练抗压决策。',
    startMonth: 12,
    startDay: 2,
    maxDay: 18,
    ...
    cases: [
      { id: 'case-ruiheli-hard', housePrototypeId: 'proto-ruiheli-89', ownerArchetypeId: 'anxious', ownerName: '周女士', ownerMood: '推进压力非常大', maintainerName: '林序', askPrice: 830, bottomPrice: 784, initialTrust: 57, initialPatience: 52, initialHeat: 54, initialUrgency: 81, windowDays: 8 },
  ...
  },
  {
    ...
    scriptedEvents: [
      { id: 'event-dead-1', day: 4, actor: '家里催促', title: '推进收紧', message: '葛女士突然把卖房期限往前提了一周。', tone: 'danger', targetCaseId: 'case-jiangyue-dead', urgencyDelta: 7, windowDaysDelta: -2 },
  ...
  },
  {
    ...
    name: '残局识别局',
    theme: '不求全救，先识别谁值得保到底',
    description: '6 套盘，多数盘先天吃亏，推进和关系都脆，适合专门练残局判断。',
    startMonth: 1,
    startDay: 9,
    maxDay: 17,
    ...
    randomEventPool: [
      { templateId: 'school-boom', weight: 1 },
      { templateId: 'policy-shift', weight: 5 },
      { templateId: 'competitor-cut', weight: 7 },
    ],
    cases: [
      { id: 'case-ruiheli-ext', housePrototypeId: 'proto-ruiheli-89', ownerArchetypeId: 'anxious', ownerName: '周女士', ownerMood: '再拖就准备换门店', maintainerName: '林序', askPrice: 828, bottomPrice: 784, initialTrust: 53, initialPatience: 40, initialHeat: 52, initialUrgency: 84, windowDays: 6 },
      { id: 'case-xinghu-ext', housePrototypeId: 'proto-xinghuyuan-92', ownerArchetypeId: 'game-player', ownerName: '郭先生', ownerMood: '对每个竞品动作都过度反应', maintainerName: '沈岚', askPrice: 858, bottomPrice: 809, initialTrust: 52, initialPatience: 38, initialHeat: 51, initialUrgency: 79, windowDays: 6 },
      { id: 'case-jiangyue-ext', housePrototypeId: 'proto-jiangyuefu-128', ownerArchetypeId: 'trial-balloon', ownerName: '顾女士', ownerMood: '随时要撤，几乎不给你犯错空间', maintainerName: '陆遥', askPrice: 1298, bottomPrice: 1198, initialTrust: 49, initialPatience: 31, initialHeat: 58, initialUrgency: 88, windowDays: 5 },
      { id: 'case-jiayue-ext', housePrototypeId: 'proto-jiayue-71', ownerArchetypeId: 'trial-balloon', ownerName: '梁先生', ownerMood: '只愿意再给很短的试错期', maintainerName: '韩起', askPrice: 634, bottomPrice: 588, initialTrust: 48, initialPatience: 29, initialHeat: 64, initialUrgency: 90, windowDays: 4 },
      { id: 'case-jiali-ext', housePrototypeId: 'proto-jiali-east-118', ownerArchetypeId: 'anxious', ownerName: '陈小姐', ownerMood: '对年底卖不掉这件事很恐慌', maintainerName: '苏景', askPrice: 1134, bottomPrice: 1046, initialTrust: 50, initialPatience: 36, initialHeat: 54, initialUrgency: 82, windowDays: 5 },
      { id: 'case-wanhang-ext', housePrototypeId: 'proto-wanhang-63', ownerArchetypeId: 'fair-value', ownerName: '徐阿姨', ownerMood: '嘴上平静，但容忍度其实也快到底', maintainerName: '许靖', askPrice: 608, bottomPrice: 564, initialTrust: 56, initialPatience: 44, initialHeat: 47, initialUrgency: 70, windowDays: 6 },
    ],
    competitionGroups: [
      { id: 'group-ext-qiantan', name: '前滩极限踩踏', members: ['case-ruiheli-ext', 'case-xinghu-ext', 'case-jiangyue-ext'], priceElasticity: 1.32, customerSpillover: 0.7 },
